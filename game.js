...
class Game {
    constructor() {
        this.ball = new Ball(canvas.width / 2, canvas.height / 2, 12, 6, 6);
        ...
        this.ball2 = new Ball(canvas.width / 2, canvas.height / 2, 8, 5, 5);
        this.ball3 = new Ball(canvas.width / 2, canvas.height / 2, 4, 4, 4);
        this.ball4 = new Ball(canvas.width / 2, canvas.height / 2, 20, 3, 3);
        this.ball5 = new Ball(canvas.width / 2, canvas.height / 2, 25, 2, 1);
    ...
    draw() {
        ...
        this.ball.draw('#FF5733');
        this.ball2.draw('#DAF7A6');
        this.ball3.draw('#FFC300');
        this.ball4.draw('#900C3F');
        this.ball5.draw('#581845');
        
        this.paddle1.draw('#1E90FF', 100);
        this.paddle2.draw('#FFD700', 0);
    }
